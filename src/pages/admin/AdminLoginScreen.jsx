...
export default function AdminLoginScreen() {
  ...
  const [email, setEmail] = useState('admin@vrindavanposhakh.com');
            ...
            <div className="relative">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full bg-[#fbf9f4] border-0 border-b border-[#00151b]/30 text-base text-[#00151b] focus:ring-0 focus:border-[#735c00] focus:border-b-2 py-2 px-1 pr-10 outline-none transition-colors"
                  placeholder="••••••••••••"
                />
                <button
                  type="button"
